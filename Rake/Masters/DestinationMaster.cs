...
namespace Rake
{
    public partial class DestinationMaster : Form
    {
        ...
        public void IncrementDestination()
        {
            ...
            SqlCommand cmd = new SqlCommand("GetMaxDestinationIDRake", con);
        ...
        private void tsBtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter Destination Name");
            ...
            {
                SqlConnection con = new SqlConnection(Connection.InvAdminConn());
                SqlCommand cmd = new SqlCommand("InsertDestinationRake", con);
                cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                SqlConnection con = new SqlConnection(Connection.InvAdminConn());
                SqlCommand cmd = new SqlCommand("UpdateDestinationRake", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void tsBtnEdit_Click(object sender, EventArgs e)
        {
                ...
                {
                    SqlConnection con = new SqlConnection(Connection.InvAdminConn());
                    SqlCommand cmd = new SqlCommand("GetDestinationOnIdRake", con);
