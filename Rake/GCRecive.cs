...
namespace Rake
{
    public partial class GCRecive : Form
    {
        int flag = 0;
        public GCRecive()
        {
        ...
        private void tsBtnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (string.IsNullOrEmpty(TxtWagon.Text))
            {
                MessageBox.Show("Please enter Wagon No");
                TxtWagon.Focus();
                return;
            }
            ...
            {
                MessageBox.Show("Please enter Gross wt No");
                TxtGrosswt.Focus();
                return;
            }
            ...
            SqlConnection con = new SqlConnection(Connection.InvAdminConn());
            SqlCommand cmd = new SqlCommand("UpdateGcRecivedRake", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@ShipMentID", LblShipmentID.Text);
            cmd.Parameters.AddWithValue("@WagonNo", TxtWagon.Text);
        ...
        {
            SqlConnection con = new SqlConnection(Connection.InvAdminConn());
            SqlCommand cmd = new SqlCommand("GetShipMentDetailsForGCRake", con);
