...
{
    public partial class RakeSummaryIndividual : Form
    {
        public RakeSummaryIndividual()
        {
            InitializeComponent();
        }
        ...
        private void RakeSummary_Load(object sender, EventArgs e)
        {
            ...
            parms[0] = new ReportParameter("Date", RakeDatatable.submitDate.Date.ToString("dd-MMM-yyyy"));
            parms[1] = new ReportParameter("Month", RakeDatatable.shipmentNo);
            ...
            //using (ExcelPackage package = new ExcelPackage(new System.IO.FileInfo(@"d:\test.xlsx")))
            //{
